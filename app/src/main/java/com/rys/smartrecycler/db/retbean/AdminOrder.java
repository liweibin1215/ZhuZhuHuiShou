...
public class AdminOrder {
    ...
    @Generated(hash = 1121932573)
    public AdminOrder(Long id, String orderNo, String deviceSn, int deskType,
    ...
    public AdminOrder(String orderNo, String deviceSn, int deskType, int deskNo, int userId, String userPhone, String recycleSum, String recycleMoney, long createTime, int upflag) {
        this.orderNo = orderNo;
        this.deviceSn = deviceSn;
        this.deskType = deskType;
        this.deskNo = deskNo;
