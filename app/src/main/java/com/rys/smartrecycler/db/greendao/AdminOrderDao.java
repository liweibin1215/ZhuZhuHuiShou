...
/** 
 * DAO for table "ADMIN_ORDER".
*/
public class AdminOrderDao extends AbstractDao<AdminOrder, Long> {

    public static final String TABLENAME = "ADMIN_ORDER";

    /**
     * Properties of entity AdminOrder.<br/>
    ...
    public AdminOrderDao(DaoConfig config) {
        super(config);
    }
    
    public AdminOrderDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ADMIN_ORDER\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ADMIN_ORDER\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, AdminOrder entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AdminOrder entity) {
        stmt.clearBindings();
    ...
    @Override
    public AdminOrder readEntity(Cursor cursor, int offset) {
        AdminOrder entity = new AdminOrder( //
    ...
    @Override
    public void readEntity(Cursor cursor, AdminOrder entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(AdminOrder entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(AdminOrder entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(AdminOrder entity) {
