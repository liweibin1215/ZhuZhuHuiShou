...
public class LogBean {
    ...
    public LogBean(int logType, String logName, String logDesc, String createTime, int upflag) {
    ...
    @Generated(hash = 979011531)
    public LogBean(Long id, int logType, String logName, String logDesc,
