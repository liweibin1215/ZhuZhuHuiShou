...
public class LogBeanDao extends AbstractDao<LogBean, Long> {
    ...
    /**
     * Properties of entity LogBean.<br/>
    ...
    public LogBeanDao(DaoConfig config) {
        super(config);
    }
    
    public LogBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LOG_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOG_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, LogBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, LogBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public LogBean readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, LogBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(LogBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(LogBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(LogBean entity) {
